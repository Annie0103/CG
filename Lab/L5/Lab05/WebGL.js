...
function main(){
    ...
    orthProjMatrix.setOrtho(-2, 2, -2, 2, -20 , 20);

	pespProjMatrix1.setPerspective(30, canvas.width*2/canvas.height, 1, 100);
...
function mouseMove(ev){ 
	...
	drawOneViewport(gl, 400, 0, canvas.width/2, canvas.height/2,
                    0.5, 0.5, 0.5,
                    orthProjMatrix, frontViewMatrix, modelMatrix1, modelMatrix2 );
	

	drawOneViewport(gl, 0, 400, canvas.width, canvas.height/2,
                    0.9, 0.9, 0.9,
