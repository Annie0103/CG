...
function change(){
	...
	draw(lightball,mdlMatrix,1.0,1.0,0.0,1.0,0.0);
	...
	mdlMatrix.scale(2.5,0.05,2.5);
	//mdlMatrix.rotate(rotateAngle,0.0,1.0,0.0);
	draw(cubeObj,mdlMatrix,0.9,0.9,0.9,1.0,4.0);//監視器
...
///////////////////////////****/////////////////////////////////////////////////////
    ...
    gl.uniform1i(programEnvCube.u_envCubeMap, 5);
...
function drawOffScreen(){
  ...
  for( let i=0; i < fox.length; i ++ ){
    initAttributeVariable(gl, program.a_Position, fox[i].vertexBuffer);
    initAttributeVariable(gl, program.a_TexCoord, fox[i].texCoordBuffer);
    initAttributeVariable(gl, program.a_Normal, fox[i].normalBuffer);
    gl.drawArrays(gl.TRIANGLES, 0, fox[i].numVertices);
  }
}
